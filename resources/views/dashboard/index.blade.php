<x-layout>
    ...
    @forelse($jobs as $job)
        <div class="bg-white rounded-2 py-2 text-center font-bold flex align-items-center px-4 mb-1 shadow-sm border-gray-100">
            <a href="{{ route('jobs.show', $job) }}" class="text-blue-500 mr-auto">{{ $job->title }}</a>
